...
#define ui1_1 ui1_1x.it_i1
	...
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5843, 968))(Current)).it_p);
	*(EIF_POINTER *)(Current + RTWA(10801, dtype)) = (EIF_POINTER) tp1;
	...
	up2 = tp2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5842, 968))(Current, up1x, up2x);
	RTHOOK(6);
...
#define ui4_2 ui4_2x.it_i4
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(10801, dtype));
	up1 = tp1;
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6026, 968))(Current, up1x)).it_i4);
	RTHOOK(3);
	ur1 = NULL;
...
#define ui4_1 ui4_1x.it_i4
	...
	if ((EIF_BOOLEAN) (ti4_1 > ((EIF_INTEGER_32) 0L))) {
		...
		RTNHOOK(11,1);
		{
			EIF_TYPE_INDEX typarr0[] = {0xFFF9,6,185,0xFF01,0,226,220,220,220,214,0xFFFF};
			EIF_TYPE typres0;
			typarr0[4] = dftype;
		...
		tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5110, 967))(Current)).it_n4);
