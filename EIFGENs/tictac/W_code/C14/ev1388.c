...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc2)) {
		...
		tp1 = *(EIF_POINTER *)(Current + RTWA(10020, dtype));
		up1 = tp1;
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5091, 967))(Current, up1x)).it_p);
		RTHOOK(4);
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(36, dtype))(Current)).it_p);
...
#define up1 up1x.it_p
	...
	tp1 = *(EIF_POINTER *)(Current + RTWA(10020, dtype));
	up1 = tp1;
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6030, 968))(Current, up1x)).it_i4);
	RTHOOK(2);
