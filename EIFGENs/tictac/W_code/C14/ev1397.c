...
extern EIF_TYPED_VALUE F1397_13153(EIF_REFERENCE);
extern void F1397_13154(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1397_13155_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1397_13155(EIF_REFERENCE);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1396, Current, 3, 0, 19671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1397_13153 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1397_13154 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1396, Current, 1, 1, 19674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1396, Current, 19674);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10060, 0xF80000B8, 0); /* start_path */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(10060, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1397_13155_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1396, Current, 0, 0, 19675);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1397_13155 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9225, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1397_13155_body (Current)).it_r;
