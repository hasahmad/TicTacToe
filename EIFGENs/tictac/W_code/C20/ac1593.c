...
void F1593_4287 (EIF_REFERENCE Current)
{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3147, 0xF8000353, 0); /* add_actions */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3147, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3148, 0xF8000353, 0); /* remove_actions */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3148, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 852))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(3148, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(5);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3120, 852))(Current, ui4_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(6);
