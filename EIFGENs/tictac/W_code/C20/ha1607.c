...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(3022, dtype)) = (EIF_INTEGER_32) loc4;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 3049, 0xF8000124, 0); /* content */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3049, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(8);
	RTDBGAA(Current, dtype, 3050, 0xF8000330, 0); /* keys */
...
body:;
	...
	if ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 == loc1) || EIF_FALSE)) {
		...
		RTHOOK(6);
		RTDBGAL(Current, 9, 0xF8000330, 0, 0); /* loc9 */
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		...
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,366,0xFF01,0xFFF9,1,185,196,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
