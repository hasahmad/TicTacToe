...
#define ui4_1 ui4_1x.it_i4
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		RTNHOOK(1,1);
		ui4_1 = arg1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5021, "is_valid", tr1))(tr1, ui4_1x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
...
#define ui4_2 ui4_2x.it_i4
	...
	switch (ti4_1) {
		case 1L:
			...
			ui4_1 = ti4_1;
			Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5673, 968))(Current, ui4_1x)).it_p);
			break;
		case 2L:
			RTHOOK(3);
			RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	...
	if ((EIF_BOOLEAN)(Result == tp1)) {
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(9392, dtype));
		ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5007, 965))(Current)).it_i4);
	...
	if (tb1) {
		...
		ui4_2 = ti4_2;
		Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5171, 967))(Current, up1x, up2x, ui4_1x, ui4_2x)).it_p);
		RTHOOK(22);
		up1 = loc1;
...
body:;
	...
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	up1 = arg1;
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5542, 968))(Current, up1x)).it_p);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
