...
#define ur1 ur1x.it_r
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,275,0xFF01,228,220,0xFFFF};
		EIF_TYPE typres0;
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,857,0xFF01,237,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
EIF_TYPED_VALUE F1324_12002 (EIF_REFERENCE Current)
{
	...
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8295, 1573))(Current)).it_b);
		tb1 = tb2;
	}
