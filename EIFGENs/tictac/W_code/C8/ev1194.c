...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(8045, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (ti4_1 - ((EIF_INTEGER_32) 1L));
	...
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(3214, "count", loc1));
	ui4_1 = ti4_1;
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5661, 968))(Current, ui4_1x)).it_p);
...
body:;
	...
	if (tb1) {
		...
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(5662, 968))(Current, up1x, ui4_1x)).it_p);
		RTHOOK(17);
		RTDBGAA(Current, dtype, 8043, 0x40000000, 1); /* item */
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(36, dtype))(Current)).it_p);
		*(EIF_POINTER *)(Current + RTWA(8043, dtype)) = (EIF_POINTER) tp1;
		...
		RTDBGAL(Current, 1, 0x40000000, 1, 0); /* loc1 */
		ui4_1 = (EIF_INTEGER_32) (loc2 + ((EIF_INTEGER_32) 1L));
		loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5661, 968))(Current, ui4_1x)).it_p);
	}
	RTHOOK(19);
