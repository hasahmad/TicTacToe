...
extern EIF_REFERENCE _A517_93();
extern EIF_REFERENCE _A517_87();
...
#define ur1 ur1x.it_r
	...
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,436,0xFF01,0xFFF9,1,185,0,0,0xFF01,971,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 8117, 0xF80001B4, 0); /* target_data_function */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(17, "twin", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTAR(Current, tr1);
...
#define ur1 ur1x.it_r
	...
	RTNHOOK(3,1);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFFF9,3,185,0xFF01,516,220,220,220,220,0xFFFF};
		EIF_TYPE typres0;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A517_87, (EIF_POINTER)(0),1744, 0, 0, 1, -1, tr2, 0);
	}
	ur1 = RTCCL(tr3);
	...
	RTNHOOK(4,1);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFFF9,2,185,0xFF01,516,220,220,220,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A517_93, (EIF_POINTER)(0),3045, 0, 0, 1, -1, tr2, 0);
	}
	ur1 = RTCCL(tr3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1711, "extend", tr1))(tr1, ur1x);
	RTVI(Current, RTAL);
